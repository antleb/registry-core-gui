    ...
    return {
        ...
        execute: function() {
            ResourceTypeService = (function () {
                ...
                ResourceTypeService.prototype.getResourceType = function (name) {
                    return this.http.get(this._resourceTypesUrl + name)
                        .map(function (res) { return res.json(); })
                        .catch(this.handleError);
                };
                ResourceTypeService.prototype.handleError = function (error) {
            ...
            exports_1("ResourceTypeService", ResourceTypeService);
        }
    }
});
//# sourceMappingURL=resource-type.service.js.map